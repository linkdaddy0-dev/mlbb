...
def main():
    ...
    # Lukas (127) <-> Marcel (132)
    swap_files(banners_dir, 127, 132)
    swap_files(paintings_dir, 127, 132)
    
    # Kalea (128) <-> Zetian (129)
    swap_files(banners_dir, 128, 129)
    swap_files(paintings_dir, 128, 129)
