...
function test() {
  ...
  try {
    const heroes = JSON.parse(fs.readFileSync('public/data/patches/1.8.84/en/heroes/index.json', 'utf8'));
    const draftMatrix = JSON.parse(fs.readFileSync('public/data/patches/1.8.84/en/draft_matrix.json', 'utf8'));
